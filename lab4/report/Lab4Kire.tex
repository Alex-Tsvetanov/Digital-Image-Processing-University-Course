...
\begin{center}
    ...
    {\fontsize{20}{24}\selectfont\bfseries Лабораторно упражнение №: 4\par Анализ и подобряване на изображения чрез хистограми, контрастни трансформации и пространствена обработка\par}
